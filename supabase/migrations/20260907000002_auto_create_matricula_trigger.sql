-- ============================================================
-- Migration: Fase 3.3 - Trigger Transacional de Autocriação de Matrícula
-- Data: 2026-09-07
-- Descrição: Cria a função e o trigger AFTER INSERT em public.alunos
--            para criar automaticamente a primeira linha em public.matriculas 
--            e em public.movimentacoes_matricula em um único bloco atômico.
-- ============================================================
...
-- Dropar e recriar o Trigger AFTER INSERT na tabela public.alunos
